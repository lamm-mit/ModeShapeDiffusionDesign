...
# # --
# from imagen_pytorch_study.imagen_pytorch import Imagen, NullUnet
# from imagen_pytorch_study.elucidated_imagen import ElucidatedImagen
# from imagen_pytorch_study.data import cycle
# --++
# from imagen_pytorch_study.imagen_x_unet_pytorch import NullUnet
# from imagen_pytorch_study.imagen_x_eimagen_pytorch import (
#     ElucidatedImagen_TwoD,
#     ElucidatedImagen_OneD
# )
# from imagen_pytorch_study.data import cycle

# ++
from VibeGen.imagen_x_unet_pytorch import (NullUnet)
from VibeGen.imagen_x_imagen_pytorch import (
    ElucidatedImagen_OneD
)

# --
# from imagen_pytorch_study.version import __version__
# ++
__version__ = '0.1.0'
...
class ImagenTrainer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # ++
        assert isinstance(imagen, (ElucidatedImagen_TwoD))
        ...
        # ++
        self.is_elucidated = isinstance(imagen, ElucidatedImagen_TwoD)
...
class ImagenTrainer_OneD(nn.Module):
    locked = False
    ...
    def __init__(
        ...
        **kwargs
        ...
        # ++
        self.CKeys = CKeys
        if self.CKeys['Debug_Level']==1:
            print (f"|||||||||||||||||||||||||||||||||||||||||||||||||||")
            print (f"Initialize ImagenTrainer_OneD object...")
        ...
        # assert isinstance(imagen, (Imagen, ElucidatedImagen))
        # ++
        # assert isinstance(imagen, (ElucidatedImagen_OneD))
        ...
        # self.is_elucidated = isinstance(imagen, ElucidatedImagen)
        # ++
        self.is_elucidated = isinstance(imagen, ElucidatedImagen_OneD)
    ...
    def forward(
        ...
        **kwargs
        ...
        # ++
        if self.CKeys['Debug_Level']==Debug_Trainer_Forw:
